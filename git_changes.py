...
def summerize_change(git_changes: str) -> str:
    ...
    Args:
        git_changes (str): A string containing the output of the `analyze_file_changes` function.

    Returns:
        str: A summary of the git changes.
    """
    prompt = f"""
...
def suggest_change_type(git_changes_summary: str) -> str:
    ...
    Args:
        git_changes_summary (str): A summary of the git changes.

    Returns:
        str: The suggested change type.
    """
    prompt = f"""
...
def fill_template(
    change_type: str, git_changes_summary: str, templates_dir: str = "templates"
) -> str:
    """
    ...
    """
    template_path = (
        Path(templates_dir) / f"{change_type.lower()}.md"
